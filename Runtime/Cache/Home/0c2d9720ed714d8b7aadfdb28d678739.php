...
<body>
    <div class="mc">
        ...
        <div class="mc_head">
            ...
            -->
            <div class="mc_user_man"><?php echo ($gg_user); ?></div>
        </div>
        <!--以上头部-->
        <div class="mc_middle">
        ...
        <div class="mc_foot">
            ...
            <div class="mc_foot_02">
                <input class="mc_02_val" type="hidden" value="<?php echo ($gg_score); ?>">
            ...
            <div class="mc_foot_03">
                <table class="mc_table">
                    <tr>
                        ...
                        <td class="mc_td_02"><span><?php echo ($gg_user); ?></span></td>
                    ...
                    <tr>
                        ...
                        <td class="mc_td_02"><span class="mc_span_01"></span></td>
                        <td class="mc_td_03"><img class="mc_btn_change" src="<?php echo ADDON_PUBLIC_PATH;?>/img/membercenter/membercenter-personal_01.png"></td>
                    </tr>
                    <tr>
                        <td class="mc_td_01">电话：</td>
                        <td class="mc_td_02"><span class="mc_span_01"><?php echo ($gg_phone); ?></span></td>
                        <td class="mc_td_03"><img class="mc_btn_change" src="<?php echo ADDON_PUBLIC_PATH;?>/img/membercenter/membercenter-personal_01.png"></td>
                    </tr>
                    <tr>
                        <td class="mc_td_01">地址：</td>
                        <td class="mc_td_02"><span class="mc_span_02"></span></td>
                        <td class="mc_td_03"><img class="mc_btn_change" src="<?php echo ADDON_PUBLIC_PATH;?>/img/membercenter/membercenter-personal_01.png"></td>
                    </tr>
                    <tr>
