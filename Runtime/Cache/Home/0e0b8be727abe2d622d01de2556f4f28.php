...
<body id="scratch">
	<div class="container body">
    	<div class="scr_top">
    		<div class="area">
            	<img src="<?php echo ADDON_PUBLIC_PATH;?>/toparea.png" style="border: 0px; margin: 0px; padding: 0px;"/>
                <div class="scratch_area" style="border: 0px; margin: 0px; padding: 0px;">
                
                  <?php if ($error) { ?>
                	<div class="prize_text" style="font-size:12px; line-height:16px;"><?php echo ($error); ?></div>   
        ...
        <div class="block_out">
        	<div class="block_inner">
                ...
                <img src="http://www.kmark.cn/weiphp/Addons/Scratch/View/default/Public/gifts.png">
                </div>
            </div>
            <!--中将记录 -->
            <div class="block_out">
